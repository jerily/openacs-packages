...
<script type="text/javascript" src="http://localhost:8000/maps/js/kaMap-all.js"></script>
...
function myMapInitialized( eventID, mapName )
{
    ...
    marker1.src='/maps/images/marker.png';
    var marker2 = document.createElement('img');
    marker2.src='/maps/images/marker.png';
    var marker3 = document.createElement('img');
    marker3.src='/maps/images/marker.png';
...
<div id="map_permalink"><a href="http://localhost:8000/" onclick="prompt('Paste link in email or IM',this.href);return false;" onmouseover="var c=myKaMap.getCenter();this.href='http://localhost:8000/?ll='+myKaMap.pixToGeo(c[0],c[1])+'&s='+myKaMap.getCurrentScale();"><span>Link to this page</span></a></div>

<div id="copyright">&copy;2023 Your Copyright Statement Here</div>
...
<a href="http://localhost:8000/" onclick="prompt('Paste link in email or IM',this.href);return false;" onmouseover="var c=myKaMap.getCenter();this.href='http://localhost:8000/?ll='+myKaMap.pixToGeo(c[0],c[1]);"><span>Link to this page</span></a>
    ...
    <td><a href="http://localhost:8000/" onclick="prompt('Paste link in email or IM',this.href);return false;" onmouseover="var c=myKaMap.getCenter();this.href='http://localhost:8000/?ll='+myKaMap.pixToGeo(c[0],c[1]);"><span>Link to this page</span></a></td>
